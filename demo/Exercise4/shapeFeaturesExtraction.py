...
# plt.scatter(r_based_fingers_indexes, [ dp[idx] for idx in r_based_fingers_indexes], c='r', label='finger points')
# plt.scatter(valley_indexes, [ dp[idx] for idx in valley_indexes], c='g', label='valley points')
# plt.scatter(comp_valley_indexes, [ dp[idx] for idx in comp_valley_indexes] , c='y', label='valley points')
...
# plt.scatter(r_based_fingers_indexes, [ op[idx] for idx in r_based_fingers_indexes], c='r', label='finger points')
